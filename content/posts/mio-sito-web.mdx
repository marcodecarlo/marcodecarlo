...
description: "Descrizione di come ho realizzato il mio sito personale, pianificando ogni fase, dall'idea iniziale alla scelta delle tecnologie, per creare una piattaforma funzionale e rappresentativa del mio lavoro."
publishedAt: "2024-09-20"
status: "published"
---

<Img src={`/mio-sito-web/home.png`} width={2154} height={1232} bleed={false} />
